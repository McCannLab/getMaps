...
png(file = 'fig/fig1_map_homogen.png', res = 900, units = 'mm', width = 180, height = 90)
#
...
box2(1:4, lwd = 1.1)
# 
mtext(expression(bold("(a)")), 3, at = -95, line = -2)
...
mtext(expression(bold("(b)")), 3, at = -95, line = -2)
#
par(mar = c(1, 1, 4, 4))
...
mtext(expression(bold("(c)")), 3, at = -95, line = -2)
#
par(mar = c(1, 1, 4, 4))
